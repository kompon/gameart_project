...
exports.createProduct = async (req, res) => {
    try {
        ...
        product.image = product.image ? `https://gameart-project.onrender.com/public/images/${product.image}` : null;
...
exports.getdata = async (req, res) => {
    try {
        ...
        const productsWithImageUrl = products.map(product => ({
            ...product.dataValues,
            image: product.image ? `https://gameart-project.onrender.com/public/images/${product.image}` : null
        }));
